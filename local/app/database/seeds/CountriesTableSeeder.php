...
class CountriesTableSeeder extends Seeder {
	...
	public function run()
	{
		DB::table('countries')->truncate(); // deleting old records.
		DB::statement('INSERT INTO `countries` (`id_countries`, `name`, `iso_alpha2`, `iso_alpha3`, `iso_numeric`, `currency_code`, `currency_name`, `currency_symbol`, `flag`) VALUES
